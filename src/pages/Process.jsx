        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              Our
              <br />
              <span className="italic text-basalt/70">Process</span>
            </motion.h1>
            <motion.p
              variants={fadeInUp}
      ...
      <section className="px-6 lg:px-12 pb-32">
        <div className="max-w-7xl mx-auto">
          <div className="relative">
            <div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-px bg-stone/20 transform md:-translate-x-1/2" />
            {processPhases.map((phase, index) => (
              ...
              >
                <div className="absolute left-0 md:left-1/2 top-0 w-4 h-4 bg-ivory border-2 border-basalt rounded-full transform -translate-x-1/2 md:-translate-x-1/2" />
                <div
                  className={`pl-8 md:pl-0 ${index % 2 === 0 ? "md:pr-16 md:text-right" : "md:order-2 md:pl-16"}`}
                >
                  <span className="font-display text-7xl font-light text-basalt/10 block mb-4">
                    {String(phase.number).padStart(2, "0")}
                  </span>
                  <h3 className="font-display text-3xl md:text-4xl font-light mb-4 text-basalt">
                    {phase.title}
                  </h3>
      ...
      <section className="px-6 lg:px-12 py-32 bg-basalt/5">
        <div className="max-w-4xl mx-auto">
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="font-display text-4xl font-light mb-16 text-center text-basalt"
          >
          ...
          <div className="space-y-8">
            {[
              ...
              <motion.div
                ...
                className="border-b border-stone/15 pb-8"
              >
                <h3 className="font-display text-xl font-light mb-4 text-basalt">{faq.question}</h3>
      ...
      <section className="px-6 lg:px-12 py-32">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="font-display text-4xl md:text-5xl font-light mb-8 text-basalt">
              Ready to begin?
            </h2>
            <p className="font-sans text-base md:text-lg text-stone mb-12 max-w-2xl mx-auto">
              Every great project starts with a conversation. Tell us about your
              vision.
            </p>
            <Link
              to="/contact"
              className="inline-block border border-basalt px-12 py-4 font-mono text-xs tracking-[0.2em] uppercase hover:bg-basalt hover:text-ivory transition-colors duration-300"
            >
              Start Your Project
            </Link>
          </motion.div>
